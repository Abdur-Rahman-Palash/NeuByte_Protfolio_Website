    ...
    <footer className="bg-white pt-12 dark:bg-gray-dark md:pt-16 lg:pt-20">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-center text-center">
          ...
          {/* Company Info */}
          <motion.div
            className="w-full px-4 md:w-1/2 lg:w-4/12"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            variants={fadeInUp}
          >
            <div className="mx-auto mb-8 max-w-[300px] lg:mb-12">
        ...
        {/* Bottom */}
        <div className="py-6 text-center text-sm text-body-color dark:text-body-color-dark">
          © {year} <span className="font-medium text-black dark:text-white">NeuByte</span>. All rights reserved.
        </div>
      </div>
    </footer>
  );

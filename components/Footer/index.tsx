      ...
      <footer className="dark:bg-gray-dark relative z-10 bg-white pt-16 md:pt-20 lg:pt-24">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  ...
                  <li>
                    <Link
                      href="/contact"
                      className="dark:text-body-color-dark inline-block text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                    >
                      Contact
                    </Link>
                  </li>
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="mr-4 flex h-8 w-8 items-center justify-center rounded-lg bg-primary/10 text-primary">
            ...
            {/* Newsletter */}
            <motion.div
              className="w-full px-4 md:w-1/2 lg:w-3/12 xl:w-4/12"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
              variants={fadeInUp}
            ...
            >
              <div className="mb-12 lg:mb-16">
                ...
                <p className="dark:text-body-color-dark mb-6 text-base text-body-color">
                  Subscribe to our newsletter for the latest updates on AI and web development.
                </p>
                <form className="flex flex-col space-y-4">
                  <input
                    type="email"
                    placeholder="Your email address"
                    className="w-full rounded-md border border-body-color border-opacity-50 bg-transparent px-4 py-3 text-base text-body-color placeholder-body-color/60 outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-white dark:border-opacity-30 dark:bg-dark dark:text-white dark:focus:border-primary"
                  />
                  <motion.button
                    type="submit"
                    className="rounded-md bg-primary px-6 py-3 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-primary/90"
          ...
          <div className="py-8">
            ...
            >
              <div className="mb-4 text-base text-body-color dark:text-body-color-dark">
                &copy; 2025 NeuByte. All rights reserved.
              </div>
